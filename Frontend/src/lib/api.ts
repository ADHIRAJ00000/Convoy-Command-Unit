...
export type OptimizerAlternativesResponse = {
  success: boolean;
  data: {
...
export const api = {
  ...
  requestOptimizerAlternatives: (body: OptimizerRequestPayload) =>
    fetcher<OptimizerAlternativesResponse>('/api/optimizer/route/alternatives', {
      method: 'POST',
      body: JSON.stringify(body),
    }),
